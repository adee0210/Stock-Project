...
if __name__ == "__main__":
    ...
    companies_json = read_latest_file_in_directory('/home/duc/Project/Stock_project/backend/data/raw/companies')
    ...
    path = f"/home/duc/Project/Stock_project/backend/data/processed/transformed_to_database_companies/process_companies_{date}.json"

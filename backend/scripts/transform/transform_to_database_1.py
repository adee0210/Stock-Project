...
if __name__ == "__main__":
    ...
    companies = read_latest_file_in_directory('/home/duc/Project/Stock_project/backend/data/raw/companies')
    markets = read_latest_file_in_directory('/home/duc/Project/Stock_project/backend/data/raw/markets')
    ...
    regions_path = f"/home/duc/Project/Stock_project/backend/data/processed/transformed_to_database_regions/process_regions_{date}.json"
    ...
    industries_path = f"/home/duc/Project/Stock_project/backend/data/processed/transformed_to_database_industries/process_industries_{date}.json"
    ...
    sicindustries_path = f"/home/duc/Project/Stock_project/backend/data/processed/transformed_to_database_sicindustries/process_sicindustries_{date}.json"

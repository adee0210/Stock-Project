...
sys.path.append('/home/duc/Project/Stock_project/elt/scripts/transform')
...
with DAG(
    ...
    crawl_news = BashOperator(
        task_id='crawl_news',
        bash_command='/bin/python3 /home/duc/Project/Stock_project/elt/scripts/extract/crawl_news.py',
    )

    crawl_ohlcs = BashOperator(
        task_id='crawl_ohlcs',
        bash_command='/bin/python3 /home/duc/Project/Stock_project/elt/scripts/extract/crawl_ohlcs.py',
    )

    load_api_to_parquet = BashOperator(
        task_id='load_api_to_parquet',
        bash_command='/bin/python3 /home/duc/Project/Stock_project/elt/scripts/load/load_api_to_parquet.py',
    )

    load_db_to_parquet = BashOperator(
        task_id='load_db_to_parquet',
        bash_command='/bin/python3 /home/duc/Project/Stock_project/elt/scripts/load/load_db_to_parquet.py',
    )

    def run_shell_script():
        result = subprocess.run(['bash', '/home/duc/Project/Stock_project/elt/scripts/load/load_parquet_to_hdfs.sh'], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
    ...
    #     task_id='load_parquet_to_hdfs',
    #     bash_command='bash /home/duc/Project/Stock_project/elt/scripts/load/load_parquet_to_hdfs.sh',
